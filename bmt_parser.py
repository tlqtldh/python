...
def sto_paser(hostname):
    ...
    for i in range(len(item_list)):
        ...
        if 'k100' in item_list[i][2]:
            ...
            r_rw_bw.append(int(item_list[i][6]))
            r_rw_iops.append(int(item_list[i][7]))
#            r_rwwrite_bw.append(int(item_list[i][47]))
#            r_rwwrite_iops.append(int(item_list[i][48]))

    return(s_read_bw, s_write_bw, r_read_bw, r_write_bw, r_rw_bw, s_read_iops, s_write_iops, r_read_iops, r_write_iops, r_rw_iops)  
