...
#print(cpu_result)
cpu_title = ['2630v4','2660v4', 'intel4108', 'intel4110', 'intel4114','intel5120']
cpu_style = ['--','--', '-', '-', '-', '-', '-']
...
bc.multi_line_chart( cpu_result, cpu_title, cpu_style, 'Thread', 'POPS', 'SysBench CPU POPS BMT' )
bc.multi_line_chart( mem_lat_result, mem_title, mem_style, 'Array Size(MB)', 'Latency(ns)', 'LMBench Memory Latency BMT' )
